...
activities = {
    ...
    "Tennis Club": {
        "description": "Tennis practice and match competitions",
        "schedule": "Mondays, Wednesdays, 3:45 PM - 5:00 PM",
        "max_participants": 12,
    ...
    "Science Olympiad": {
        "description": "STEM competition with hands-on experiments and problem solving",
        "schedule": "Tuesdays and Thursdays, 4:30 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["nathan@mergington.edu", "emily@mergington.edu"]
    }
}
